<%-- 
    Document   : ForgotPasswordValidate
    Created on : Jun 17, 2015, 9:17:06 PM
    Author     : Jeffin_Ben
--%>
...
<html>
    ...
    <center>
        ...
        try{
            ...
            PreparedStatement prepstmt = conn.prepareStatement("SELECT securityanswer FROM user WHERE email IN(?)");
            prepstmt.setString(1,request.getParameter("emailTextBox"));
            ResultSet rs = prepstmt.executeQuery();
            rs.next();
            if(rs.getString("securityanswer").equals(request.getParameter("securityAnswerTextBox"))) {
               ...
               boolean flag = stmt.execute(SQL);
                ...
                %>
                <br><br><h2>Wrong Security Answer!</h2>
                <%
            }
